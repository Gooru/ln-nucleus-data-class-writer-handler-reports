...
public class DCAOfflineStudentReportingHandler implements DBHandler {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(DCAOfflineStudentReportingHandler.class);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (collectionType.equalsIgnoreCase(EventConstants.EXTERNAL_ASSESSMENT) || collectionType
      ...
      if (percentScore != null) {
        ...
        Double rawScore = Double
            .valueOf(requestPayload.getValue(AJEntityDailyClassActivity.SCORE).toString());
    ...
    new DefAJEntityDailyClassActivityBuilder()
        .build(dcaReport, requestPayload, AJEntityDailyClassActivity.getConverterRegistry());
        ...
        if (collectionType.equalsIgnoreCase(EventConstants.EXTERNAL_COLLECTION) && userIds != null
          ...
          userIds.forEach(user -> {
            ...
            if (dcaReport.insert()) {
              ...
              GEPEventDispatcher eventDispatcher = new GEPEventDispatcher(dcaReport,
                  this.totalResTS, this.totalResMaxScore, this.totalResScore,
  ...
  private ExecutionResult<MessageResponse> processResourcePlayData(JsonObject requestPayload,
    ...
    if (requestPayload.getJsonArray(RESOURCES) != null && !requestPayload.getJsonArray(RESOURCES)
      ...
      for (Object res : resources) {
        ...
        duplicateRow =
            AJEntityDailyClassActivity
                .findBySQL(AJEntityDailyClassActivity.FIND_RESOURCE_EVENT, collectionId,
                    requestPayload.getString(AJEntityDailyClassActivity.SESSION_ID),
        ...
        dcaReport.set(AJEntityDailyClassActivity.GOORUUID, userId);
        dcaReport
            .set(AJEntityDailyClassActivity.EVENTNAME, EventConstants.COLLECTION_RESOURCE_PLAY);
        dcaReport.set(AJEntityDailyClassActivity.EVENTTYPE, EventConstants.STOP);
        ...
        new DefAJEntityDailyClassActivityBuilder()
            .build(dcaReport, requestPayload, AJEntityDailyClassActivity.getConverterRegistry());
        new DefAJEntityDailyClassActivityBuilder()
            .build(dcaReport, resource, AJEntityDailyClassActivity.getConverterRegistry());
