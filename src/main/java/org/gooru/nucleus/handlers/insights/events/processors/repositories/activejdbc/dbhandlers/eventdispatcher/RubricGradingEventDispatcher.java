...
public class RubricGradingEventDispatcher {
  ...
  private JsonObject createGradingCompleteTeacherNotificationEvent() {
    ...
    selfReportEvent.put(NotificationConstants.NOTIFICATION_TYPE,
        NotificationConstants.TEACHER_GRADING_COMPLETE);
    selfReportEvent
        .put(NotificationConstants.USER_ID, rubricGrading.get(AJEntityRubricGrading.STUDENT_ID));
    selfReportEvent
        .put(NotificationConstants.CLASS_ID, rubricGrading.get(AJEntityRubricGrading.CLASS_ID));
    selfReportEvent
        .put(NotificationConstants.COURSE_ID, rubricGrading.get(AJEntityRubricGrading.COURSE_ID));
    selfReportEvent
        .put(NotificationConstants.UNIT_ID, rubricGrading.get(AJEntityRubricGrading.UNIT_ID));
    selfReportEvent
        .put(NotificationConstants.LESSON_ID, rubricGrading.get(AJEntityRubricGrading.LESSON_ID));
    ...
    selfReportEvent.put(NotificationConstants.CURRENT_ITEM_ID,
        rubricGrading.get(AJEntityRubricGrading.COLLECTION_ID));
