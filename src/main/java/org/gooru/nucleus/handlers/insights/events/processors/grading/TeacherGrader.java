 ...
 * @author mukul@gooru
 */
public class TeacherGrader extends Grader {
  private static final Logger LOGGER = LoggerFactory.getLogger(TeacherGrader.class);

  @Override
  protected MessageResponse processDCAOfflineActivity() {
    MessageResponse response = null;
    try {
      response = RepoBuilder.buildGradingRepo(context).processDCAOATeacherGrades();
    } catch (Throwable t) {
