...
@Table("dca_taxonomy_report")
public class AJEntityDCATaxonomyReport extends Model {

	private static final Logger LOGGER = LoggerFactory.getLogger(AJEntityDCATaxonomyReport.class);
    ...
    public static final String SELECT_TAXONOMY_REPORT_MAX_SEQUENCE_ID =
            "SELECT max(sequence_id) FROM dca_taxonomy_report";
   
    
    public static final String RESOURCE_ATTEMPT_STATUS_TYPE = "attempt_status";    
    public static final String PGTYPE_TEXT = "text";
    
    public static final String INSERT_TAXONOMY_REPORT = "INSERT INTO dca_taxonomy_report (sequence_id, session_id, actor_id, subject_id, course_id,domain_id, standard_id, learning_target_id, display_code, collection_id, resource_id, resource_type, question_type, answer_object, resource_attempt_status, views, reaction, score, time_spent) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
