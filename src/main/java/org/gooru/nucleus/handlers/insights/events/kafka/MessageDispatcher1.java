package org.gooru.nucleus.handlers.insights.events.kafka;
...
public final class MessageDispatcher1 {
  private static final MessageDispatcher1 INSTANCE = new MessageDispatcher1();
  private static final Logger LOGGER = LoggerFactory.getLogger(MessageDispatcher1.class);

  private MessageDispatcher1() {
  }

  public static MessageDispatcher1 getInstance() {
    return INSTANCE;
  }
