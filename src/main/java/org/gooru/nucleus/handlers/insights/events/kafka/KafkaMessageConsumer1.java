...
public class KafkaMessageConsumer1 implements Runnable {

  private static final Logger LOGGER = LoggerFactory.getLogger(KafkaMessageConsumer1.class);
  private KafkaConsumer<String, String> consumer = null;

  public KafkaMessageConsumer1(KafkaConsumer<String, String> consumer) {
