...
public class LTIEventDispatcher {
    ...
    public LTIEventDispatcher(AJEntityDailyClassActivity dcaReports, Long timeSpent, String updated_at, Double rawScore, Double maxScore, Double score, Boolean isGraded) {
