...
public class OfflineStudentReportingProcessor implements Processor {
    ...
    public OfflineStudentReportingProcessor(Message<Object> message) {
    ...
    private ProcessorContext createContext() {
        ...
        // No UserId, so assigning it to Null. Ideally update the
        // createContext() method to NOT have
        // userId as the parameter, since even Rubrics doesn't need that
        // anymore.
