...
//            + "AND resource_type = 'question' ORDER BY resource_id, updated_at desc) questionData GROUP BY session_id";
  ...
  // Removing resource_type = 'question'
...
//            + "WHERE actor_id = ? AND session_id = ? AND collection_id = ? AND event_type = ? AND event_name = ? ";
  ...
  public static final String CHECK_DUPLICATE_COLLECTION_EVENT =
      "SELECT id, views, time_spent, score, reaction, resource_attempt_status, answer_object FROM base_reports "
          + "WHERE actor_id = ? AND session_id = ? AND collection_id = ? AND event_type = ? AND event_name = ? ";
  ...
  public static final String UPDATE_RESOURCE_EVENT =
      "UPDATE base_reports SET views = ?, time_spent= ?, score = ?, updated_at = ?, "
...
//            + "ORDER BY updated_at DESC LIMIT 1";
  ...
  public static final String FIND_COLLECTION_TYPE =
      "SELECT collection_type FROM base_reports WHERE class_id = ? AND course_id = ? "
  ...
  public static final String UPDATE_ASSESSMENT_SCORE =
      "UPDATE base_reports SET score = ?, max_score = ? WHERE collection_id = ? AND session_id =  ? "
          + "AND event_name = 'collection.play' AND event_type = 'stop'";

  public static final String UPDATE_QUESTION_SCORE_U =
      "UPDATE base_reports SET score = ?, is_graded = ?, resource_attempt_status = ? "
  ...
  public static final String UPDATE_ASSESSMENT_SCORE_U =
      "UPDATE base_reports SET score = ?, max_score = ? WHERE actor_id = ? AND class_id = ? "
  ...
  public static final String CHECK_IF_EXT_ASSESSMENT_SELF_GRADED =
      "SELECT id, views, time_spent, score, reaction FROM base_reports "
