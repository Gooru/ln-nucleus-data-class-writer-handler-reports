...
public class TeacherScoreOverideEventDispatcher {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(TeacherScoreOverideEventDispatcher.class);
  ...
  private JsonObject createTeacherScoreUpdateNotificationEvent(Model reports) {
    ...
    teacherScoreUpdateEvent
        .put(NotificationConstants.NOTIFICATION_TYPE, NotificationConstants.TEACHER_SCORE_OVERRIDE);
    teacherScoreUpdateEvent
        .put(NotificationConstants.USER_ID, reports.get(AJEntityReporting.GOORUUID));
    teacherScoreUpdateEvent
    ...
    teacherScoreUpdateEvent.put(NotificationConstants.CURRENT_ITEM_TYPE,
        reports.get(AJEntityReporting.COLLECTION_TYPE));
    teacherScoreUpdateEvent
        .put(NotificationConstants.PATH_ID, reports.get(AJEntityReporting.PATH_ID));
    teacherScoreUpdateEvent
