...
public class GEPEventDispatcher {
    ...
    public GEPEventDispatcher(AJEntityDailyClassActivity dcaReport, Long timespent, Double maxScore, Double score, long activityTime) {
        this.dcaReport = dcaReport;
        this.activityTime = activityTime;
    }

    public GEPEventDispatcher(AJEntityReporting baseReports, Long timespent, Double maxScore, Double score, long activityTime) {
    ...
    private JsonObject createCRPEvent(Model report) {
        ...
        gepCRPEvent.put(GEPConstants.RESOURCE_ID, report.getString(AJEntityDailyClassActivity.RESOURCE_ID));
        gepCRPEvent.put(GEPConstants.RESOURCE_TYPE, report.getString(AJEntityDailyClassActivity.RESOURCE_TYPE));

        context.put(GEPConstants.COLLECTION_ID, report.getString(AJEntityDailyClassActivity.COLLECTION_OID));
        context.put(GEPConstants.COLLECTION_TYPE, report.getString(AJEntityDailyClassActivity.COLLECTION_TYPE));
        context.put(GEPConstants.CONTEXT_COLLECTION_ID, report.getString(AJEntityDailyClassActivity.CONTEXT_COLLECTION_ID));
        context.put(GEPConstants.CONTEXT_COLLECTION_TYPE, report.getString(AJEntityDailyClassActivity.CONTEXT_COLLECTION_TYPE));
        context.put(GEPConstants.CLASS_ID, report.getString(AJEntityDailyClassActivity.CLASS_GOORU_OID));
        context.put(GEPConstants.COURSE_ID, report.getString(AJEntityDailyClassActivity.COURSE_GOORU_OID));
        context.put(GEPConstants.UNIT_ID, report.getString(AJEntityDailyClassActivity.UNIT_GOORU_OID));
        context.put(GEPConstants.LESSON_ID, report.getString(AJEntityDailyClassActivity.LESSON_GOORU_OID));
        ...
        result.put(GEPConstants.ANSWER_STATUS, report.getString(AJEntityDailyClassActivity.RESOURCE_ATTEMPT_STATUS));
    ...
    private JsonObject createCPEvent(Model report) {
        ...
        gepCPEvent.put(GEPConstants.COLLECTION_ID, report.getString(AJEntityDailyClassActivity.COLLECTION_OID));
        gepCPEvent.put(GEPConstants.COLLECTION_TYPE, report.getString(AJEntityDailyClassActivity.COLLECTION_TYPE));
        context.put(GEPConstants.CONTEXT_COLLECTION_ID, report.getString(AJEntityDailyClassActivity.CONTEXT_COLLECTION_ID));
        context.put(GEPConstants.CONTEXT_COLLECTION_TYPE, report.getString(AJEntityDailyClassActivity.CONTEXT_COLLECTION_TYPE));
