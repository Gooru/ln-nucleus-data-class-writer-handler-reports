...
public class EventConstants {
  ...
  public static final Pattern SESSION_ACTIVITY_EVENTS_PATTERN = Pattern
      .compile("collection.play|collection.resource.play|reaction.create|resource.user.feedback");
  ...
  public static final Pattern PLAY_EVENTS_PATTERN = Pattern
      .compile("collection.play|collection.resource.play|reaction.create|resource.play");

  public static final Pattern OBJECT_CREATOR_EVENTS_PATTERN = Pattern.compile(
      "collection.play|collection.resource.play|reaction.create|resource.play|item.delete|item.move|item.remove");
  ...
  public static final Pattern RECOMPUTATION_EVENTS_PATTERN = Pattern
      .compile("item.delete|item.move|item.remove");
