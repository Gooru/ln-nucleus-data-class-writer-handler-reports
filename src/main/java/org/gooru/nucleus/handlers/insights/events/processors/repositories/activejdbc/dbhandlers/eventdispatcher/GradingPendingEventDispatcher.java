...
public class GradingPendingEventDispatcher {
    ...
    private JsonObject createGradingPendingNotificationEvent(Model reports) {
        ...
        pendingGradingEvent.put(NotificationConstants.CLASS_ID, reports.get(AJEntityReporting.CLASS_GOORU_OID));
        pendingGradingEvent.put(NotificationConstants.COURSE_ID, reports.get(AJEntityReporting.COURSE_GOORU_OID));
        pendingGradingEvent.put(NotificationConstants.UNIT_ID, reports.get(AJEntityReporting.UNIT_GOORU_OID));
        pendingGradingEvent.put(NotificationConstants.LESSON_ID, reports.get(AJEntityReporting.LESSON_GOORU_OID));
        pendingGradingEvent.put(NotificationConstants.COLLECTION_ID, reports.get(AJEntityReporting.COLLECTION_OID));
        ...
        pendingGradingEvent.put(NotificationConstants.CURRENT_ITEM_ID, reports.get(AJEntityReporting.COLLECTION_OID));
        pendingGradingEvent.put(NotificationConstants.CURRENT_ITEM_TYPE, reports.get(AJEntityReporting.COLLECTION_TYPE));
        pendingGradingEvent.put(NotificationConstants.PATH_ID, reports.get(AJEntityReporting.PATH_ID));
        pendingGradingEvent.put(NotificationConstants.PATH_TYPE, reports.get(AJEntityReporting.PATH_TYPE));
