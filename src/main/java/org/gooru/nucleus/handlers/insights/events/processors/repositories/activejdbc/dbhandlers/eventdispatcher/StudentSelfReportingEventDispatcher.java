...
public class StudentSelfReportingEventDispatcher {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(StudentSelfReportingEventDispatcher.class);
  ...
  private JsonObject createSelfReportNotificationEvent() {
    ...
    selfReportEvent
        .put(NotificationConstants.NOTIFICATION_TYPE, NotificationConstants.STUDENT_SELF_REPORT);
    selfReportEvent.put(NotificationConstants.USER_ID, baseReports.get(AJEntityReporting.GOORUUID));
    selfReportEvent
        .put(NotificationConstants.CLASS_ID, baseReports.get(AJEntityReporting.CLASS_GOORU_OID));
    selfReportEvent
        .put(NotificationConstants.COURSE_ID, baseReports.get(AJEntityReporting.COURSE_GOORU_OID));
    selfReportEvent
        .put(NotificationConstants.UNIT_ID, baseReports.get(AJEntityReporting.UNIT_GOORU_OID));
    selfReportEvent
    ...
    selfReportEvent
        .put(NotificationConstants.PATH_TYPE, baseReports.get(AJEntityReporting.PATH_TYPE));
